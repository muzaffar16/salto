(function () {
  ...
  function init() {
    ...
    const licenseKey = script?.dataset?.licensekey || "";

    // const srcRoot = "http://localhost:5173"; // Change to production later
    ...
    iframe.src = `${srcRoot}/?licenseKey=${encodeURIComponent(licenseKey)}`;
